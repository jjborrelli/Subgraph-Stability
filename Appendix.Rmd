...
fplot <- ggplot(plot.df, aes(x = variable, y = value)) + geom_boxplot()
...
fplot <- ggplot(sort.df, aes(x = 1:13, y = value)) + geom_point(shape = 19, size = 3)
fplot + xlab("Subgraph") + ylab("Quasi Sign-Stability") + scale_x_discrete(limits=names(sorted))
```
